...
public class MainWindow extends JFrame {
    ...
    private SumPanel infoAN, infoRE, infoPU, infoEX, infoST;
    private UStPanel panelUSt;
    private ZmPanel panelZM;
    private TaxPanel panelP109a;
    private JScrollPane sPaneErg;
    private CreateTable<Object> sPaneAN, sPaneRE, sPanePU, sPaneEX, sPaneST;
    private CreatePanel panelOfferInfo, panelBillInfo;
    ...
    private void doAngebotPanel(boolean use) {
        ...
        sPaneAN = new CreateTable<>(sTempAN, HEADER_AN, new TableANcr(this));
    ...
    private void doRechnungPanel(boolean use) {
        ...
        sPaneRE = new CreateTable<>(sTempRE, HEADER_RE, new TableREcr(this));
    ...
    private void doEinkaufPanel() {
        ...
        CreatePanel cp = new CreatePanel(sPanePU, purchasePanel, null, infoPU);
        pagePU.removeAll();
    ...
    private void doAusgabenPanel() {
        ...
        CreatePanel cp = new CreatePanel(sPaneEX, expensesPanel, null, infoEX);
        pageEX.removeAll();
    ...
    private void doSvsTaxPanel() {
        ...
        CreatePanel cp = new CreatePanel(sPaneST, svTaxPanel, null, infoST);
        pageST.removeAll();
    ...
    private void doJahresergebnis() {
        ...
        panelZM = new ZmPanel(); panelZM.setBorder(BorderFactory.createEmptyBorder(5,5,5,5));
        panelP109a = new TaxPanel(); panelP109a.setBorder(BorderFactory.createEmptyBorder(5,5,5,5));
    ...
    private void doEinstellungen() {
        ...
        cmbSelect.addActionListener(_ -> {
            ...
            switch (cmbSelect.getSelectedIndex()) {
                ...
                case 5 -> pageSetting.add(new UserPanel());
                case 6 -> { pageSetting.add(new TaxTablePanel()); pageSetting.add(new GwbTablePanel()); }
                case 7 -> pageSetting.add(new QrPanel());
                case 8 -> pageSetting.add(new DbPanel());
    ...
    private void buildStatusBar() {
        ...
        txtWirtschaftsjahr = new JTextField(LoadData.getStrAktGJ(), 8);
        txtWirtschaftsjahr.addActionListener(_ -> {
            ...
            try { saveSettingsApp(LoadData.getPrpAppSettings()); }
