...
public class TextZahlErin extends TextPanel  {
	
	// Serialisierungs-ID für die Klasse
	private static final long serialVersionUID = 1L;
	
	private static final Logger logger = LogManager.getLogger(TextZahlErin.class);
	...
	public TextZahlErin() {
        super("Textbausteine für Zahlungserinnerung bearbeiten");
    ...
    private void buildUI() {
		...
		String[] labels = {
				"Textbaustein Zahlungserinnerung B16", "Textbaustein Zahlungserinnerung B18/a",	"Textbaustein Zahlungserinnerung B18/b",
				"Textbaustein Zahlungserinnerung B18/c", "Textbaustein Zahlungserinnerung B20", "Textbaustein Zahlungserinnerung B21",
				"Textbaustein Zahlungserinnerung B22", "Textbaustein Zahlungserinnerung B23", "Textbaustein Zahlungserinnerung B26",
				"Textbaustein Zahlungserinnerung B27", "Textbaustein Zahlungserinnerung ...", "Textbaustein Zahlungserinnerung ...",
				"Textbaustein Zahlungserinnerung ...", "Textbaustein Zahlungserinnerung ...", "Textbaustein Zahlungserinnerung ..."};
    ...
    private void texte() {
    	...
    	for (int i = 0; i < n; i++) {
    	    ...
    	    textAreas.get(i).setText(tx.getTextZahlErin());
