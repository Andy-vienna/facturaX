...
public class TextAngebotRev extends TextPanel  {
	
	// Serialisierungs-ID für die Klasse
	private static final long serialVersionUID = 1L;
	
	private static final Logger logger = LogManager.getLogger(TextAngebotRev.class);
	...
	public TextAngebotRev() {
        super("Textbausteine für Angebotsrevisionen bearbeiten");
    ...
    private void texte() {
    	...
    	for (int i = 0; i < n; i++) {
    	    ...
    	    placeholderList.get(i).setText(tx.getVarTextAngebotRev());
    	    textAreas.get(i).setText(tx.getTextAngebotRev());
    ...
    private void handleButtonClick(int index, JTextField txtVar, JTextPane txtPane) {
        ...
        text.setVarTextAngebotRev(txtVar.getText());
        text.setTextAngebotRev(txtPane.getText());
        repo.update(text);
        texte();
    }
