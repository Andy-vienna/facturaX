...
public class TextRechnung extends TextPanel  {
	
	// Serialisierungs-ID für die Klasse
	private static final long serialVersionUID = 1L;
	
	private static final Logger logger = LogManager.getLogger(TextRechnung.class);
    ...
    private void texte() {
    	...
    	for (int i = 0; i < n; i++) {
    	    ...
    	    placeholderList.get(i).setText(tx.getVarTextRechnung());
    	    textAreas.get(i).setText(tx.getTextRechnung());
    ...
    private void handleButtonClick(int index, JTextField txtVar, JTextPane txtPane) {
        ...
        text.setVarTextRechnung(txtVar.getText());
        text.setTextRechnung(txtPane.getText());
        repo.update(text);
        texte();
    }
