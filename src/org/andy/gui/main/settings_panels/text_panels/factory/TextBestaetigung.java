...
public class TextBestaetigung extends TextPanel  {
    ...
    private void buildUI() {
		...
		String[] labels = {
				"Textbaustein Auftragsbestätigung A35", "Textbaustein Auftragsbestätigung A38",	"Textbaustein Auftragsbestätigung A44",
				"Textbaustein Auftragsbestätigung A47",	"Textbaustein Auftragsbestätigung QR-Code", "Textbaustein Auftragsbestätigung ...",
				"Textbaustein Auftragsbestätigung ...", "Textbaustein Auftragsbestätigung ...", "Textbaustein Auftragsbestätigung ...",
				"Textbaustein Auftragsbestätigung ...", "Textbaustein Auftragsbestätigung ...", "Textbaustein Auftragsbestätigung ...",
				"Textbaustein Auftragsbestätigung ...", "Textbaustein Auftragsbestätigung ...", "Textbaustein Auftragsbestätigung ..."};
