...
public class TextMahnung extends TextPanel  {
	
	// Serialisierungs-ID für die Klasse
	private static final long serialVersionUID = 1L;
	
	private static final Logger logger = LogManager.getLogger(TextMahnung.class);
	...
	public TextMahnung() {
        super("Textbausteine für Mahnung bearbeiten");
    ...
    private void buildUI() {
		...
		String[] labels = {
				"Textbaustein Mahnung B16", "Textbaustein Mahnung B18/a", "Textbaustein Mahnung B18/b",
				"Textbaustein Mahnung B18/c", "Textbaustein Mahnung B20/a", "Textbaustein Mahnung B20/b",
				"Textbaustein Mahnung B21/a", "Textbaustein Mahnung B21/b",	"Textbaustein Mahnung B22/a",
				"Textbaustein Mahnung B22/b", "Textbaustein Mahnung B23/a", "Textbaustein Mahnung B23/b",
				"Textbaustein Mahnung B26", "Textbaustein Mahnung B27", "Textbaustein Mahnung ..."};
    ...
    private void texte() {
    	...
    	for (int i = 0; i < n; i++) {
    	    ...
    	    textAreas.get(i).setText(tx.getTextMahnung());
