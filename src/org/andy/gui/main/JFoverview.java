		...
		try {
			if(AnzExpenses > 0) {
				for(int x = 1; (x - 1) < AnzExpenses; x++) {
					...
					if(iQuartal == 3) {
						if(sValue.equals("20")) {
							bd066Q2 = bd066Q3.add(new BigDecimal(arrExpenses[x][5].trim()));
						}
						if(sValue.equals("10")) {
							bd067Q2 = bd067Q3.add(new BigDecimal(arrExpenses[x][5].trim()));
						}
						if(sValue.equals("13")) {
							bd068Q2 = bd068Q3.add(new BigDecimal(arrExpenses[x][5].trim()));
						}
					}
					
					if(iQuartal == 4) {
						if(sValue.equals("20")) {
							bd066Q2 = bd066Q4.add(new BigDecimal(arrExpenses[x][5].trim()));
						}
						if(sValue.equals("10")) {
							bd067Q2 = bd067Q4.add(new BigDecimal(arrExpenses[x][5].trim()));
						}
						if(sValue.equals("13")) {
							bd068Q2 = bd068Q4.add(new BigDecimal(arrExpenses[x][5].trim()));
						}
					}
